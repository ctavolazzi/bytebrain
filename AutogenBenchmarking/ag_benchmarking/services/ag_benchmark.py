...
from ..models.agent_config import ConversationConfig
...
class BenchmarkService:
    ...
    def __init__(self):
        ...
        logger.debug("Initializing BenchmarkService")
    ...
    async def benchmark_conversation(
        ...
        try:
            logger.debug(f"Starting benchmark for conversation with {len(config.agents)} agents")
            ...
            logger.debug("Running conversation...")
